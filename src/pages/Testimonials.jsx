...
function Testimonials() {
  ...
  return (
    <div className="container mx-auto px-4  m-8 h-86">
      ...
      <div className="testimonials grid grid-cols-3 gap-6 w-10/12 mx-auto ">
        <div className="testimonial bg-green-50 rounded-lg shadow-md p-6 space-y-2">
          ...
          <img
              src={
                testimonials[(currentIndex + 1) % testimonials.length].profile
                  .image
              }
              alt="Profile"
            ...
            <div className="">
              ...
              <h3 className="text-xl font-bold">
                {testimonials[currentIndex].profile.name}
              </h3>
              <p className="text-gray-600">
                {testimonials[currentIndex].profile.location}
              </p>
            </div>
          </div>
          <div className="border-b w-full space-y-4"></div>
          <p className="text-gray-700">{testimonials[currentIndex].text}</p>
        </div>

        <div className="testimonial bg-red-50 rounded-lg shadow-md p-6 space-y-2">
          <div className="profile flex items-center mb-4">
          <div className=" rounded-full border border-gray-300 w-20 h-20 mr-4 flex items-center justify-center">
          <img
              src={
        ...
        <div className="testimonial bg-blue-50 rounded-lg shadow-md p-6 space-y-2">
          <div className="profile flex items-center mb-4">
          <div className=" rounded-full border border-gray-300 w-20 h-20 mr-4 flex items-center justify-center">
          <img
              src={
